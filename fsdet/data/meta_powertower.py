...
__all__ = ["register_meta_powertower"]


def load_filtered_powertower_instances(
    ...
    if is_shots:
        fileids = {}
        split_dir = os.path.join("datasets", "powertowersplit")
        if "seed" in name:
    ...
    if is_shots:
        for cls, fileids_ in fileids.items():
            ...
            for fileid in fileids_:
                dirname = os.path.join("datasets", "powertower")
...
def register_meta_powertower(
    ...
    DatasetCatalog.register(
        name,
        lambda: load_filtered_powertower_instances(
